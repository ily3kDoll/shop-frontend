  ...
  return (
    <div className="flex flex-col gap-4 ">
      ...
      <Form {...form}>
        ...
        >
          <div className="flex flex-col gap-2 bg-white shadow-md rounded-lg item-center p-4 w-full">
            <div className="flex gap-2 justify-between">
              <h1 className="text-xl font-semibold self-center">Create Blog</h1>
              <Button className="self-end bg-green-500 hover:bg-green-600 shadow-md">
                Tạo
              </Button>
            </div>
            <div className="flex flex-col gap-4">
